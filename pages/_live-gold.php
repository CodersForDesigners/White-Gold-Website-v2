...
/*
 *
 * This is the "Test"-specific Live Gold page.
 *
 */
...
<section class="live-gold-section fill-dark hide">
	<!-- Live Gold Content -->
	<div class="live-gold space-200-top-bottom">
		<div class="row">
			<div class="container">
				<div class="live-gold-data columns small-12 medium-5 large-4 space-200-bottom">
					...
					<div class="timestamp label space-150-bottom"><span class="date inline js_current_date"></span>&ensp;&bull;&ensp;<span class="time inline js_current_time"></span></div>
					<div class="data inline">
						<div class="24k space-50-bottom">
							<div class="h6 text-yellow-2">24 Karat Gold</div>
							<div class="live-rate">
								<span class="rate h2 medium text-yellow-2 inline js_24_karat_per_gram"><!-- ₹ 5,011.4 --></span>
						...
						<div class="22k space-50-top">
							<div class="h6 text-yellow-2">22 Karat Hallmark Gold</div>
							<div class="live-rate">
								<span class="rate h2 medium text-yellow-2 inline js_22_karat_per_gram"><!-- ₹ 4,900.3 --></span>
								<span class="trend inline space-25-left-right">
									<span class="trend-icon"></span>
								</span>
								<span class="unit h6 inline"> per gram</span>
		...
		<div class="row">
			<div class="container">
						...
						<form class="form form-base" onsubmit="event.preventDefault()">
							...
							<div class="columns small-12 space-50-top">
								<label class="form-label block">
									<input type="text" placeholder="Quantity (in grams)" class="form-input-field block" id="js_quotation_form_input_quantity">
							...
							<div class="columns small-12 space-50-top space-100-bottom">
								<label class="form-label block">
									<select class="form-input-field block" id="js_quotation_form_input_purity">
										<option value="cost__24KaratGold__perGram" selected>24 Karat</option>
										<option value="cost__22KaratGold__perGram">22 Karat</option>
									</select>
							...
							<div class="quote-output fill-yellow-1 columns small-12 radius-25" style="overflow: hidden;">
								<div class="row">
									...
									<div class="value h6 inline-middle columns small-7 space-50 text-right js_basic_rate">₹ -,--,---</div>
								</div>
								...
								<div class="row">
									...
									<div class="value h6 inline-middle columns small-6 space-50 text-right js_service_charge">- ₹ --,---</div>
								</div>
								<div class="row fill-yellow-2">
									<div class="p inline-middle columns small-5 space-50">Final Quotation</div>
									<div class="value h4 strong inline-middle columns small-7 space-50 text-right js_final_quotation">₹ -,--,---</div>
								</div>
							</div>
						</form>
				...
				<div class="live-gold-video columns small-12 medium-7 medium-offset-5 large-5 large-offset-4 invisible" style="margin-top: 25vw;">
...
<script type="text/javascript" src="/js/modules/gold-rates.js<?= $ver ?>"></script>
