		...
		<div class="menu-content columns small-12 large-9" bis_skin_checked="1">
			<div class="row space-25" bis_skin_checked="1">
				...
				<div class="columns small-6 large-3 space-25" bis_skin_checked="1">
					<a class="menu-button block fill-blue-5" href="tel:+918884303333">Sell Gold</a>
				</div>
				<div class="columns small-6 large-3 space-25" bis_skin_checked="1">
					<a class="menu-button block fill-light" href="tel:+918884303333">Release Gold</a>
				</div>
			</div>
		</div>
		<!-- Menu Controls -->
...
<section class="ads-lp-banner fill-blue-5">
    ...
    <img src="/content/cms/ap-sell-gold-1.png" class="img-fluid w-md-300 w-sm-320 d-lg-none d-md-none d-tab-none"></div>
    <div class="text-right text-sm-center">
    <img src="/cms/../content/cms/ap-sell-gold-1.png" class="img-fluid w-sm-250 d-none d-md-block mx-md-ld-auto"></div>
...
<a class="btn-custom-primary mt-4" style="color: #000 !important;background-color:#fff!important;" target="_self" href="tel:+918884303333">Sell your Gold now</a>
</div>
...
<li>Offering lower value for your gold and do not possess a track record of positive customer feedback. </li>
      ...
      <td><ul>
<li>Proven track record with 49+ branches and 6,00,000+ satisfied customers who have trusted White Gold to get the right value for their gold. </li>
</ul></td>
    </tr>
    <tr>
...
<img src="/cms/../content/cms/Frame-4213-3.png" class="img-fluid d-lg-none d-md-none">
...
<p class="text-white"> <span class="text-yellow-2"> 49+ </span> Branches</p>
</div>
...
<div class="col-lg-5 align-self-end">
 <img src="/content/cms/Frame-4213-3-1.png" class="img-fluid d-none d-md-block d-tab-none">
</div>
...
<div class="container">
  <div class="text-center">
<h2>We buy your gold at the right price - no hidden charges-100% transparency. </h2>
<a class="btn-custom-primary mt-4" target="_self" href="tel:+918884303333">Sell your Gold now</a>
</div>
