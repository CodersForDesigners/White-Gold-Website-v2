...
<h2 class="pb-4">Releasing Pledged Gold? We Make It Quick & Hassle-Free in 8 Steps</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Receipt <span class="text-white">Bring the original receipt from your lender. It helps us verify and process the gold release accurately.</span></h4>
...
<h4 class="text-white">Carry a Valid Photo ID <span class="text-white">Keep your Aadhaar, Passport, or any government-issued ID ready for fast and secure KYC processing.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Visit Your Nearest White Gold Branch<span class="text-white">Reach out to the closest White Gold branch in Andhra Pradesh our team is ready to assist you.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Complete KYC & Safety Check <span class="text-white">We will verify your ID and address and confirm details with a family member over the phone for added security.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Get the Real-Time Gold Rate  <span class="text-white">We calculate your final offer based on live market rates and verified purity—no inflated promises or hidden cuts.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Finalize the Gold Loan Closure  <span class="text-white">Once verified, we will close your loan smoothly and document the transfer clearly.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Confirm Gold Purity <span class="text-white">We use German-imported XRF machines that are 100% non-damaging and tamper-proof, ensuring true value for your gold.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Bank Transfer <span class="text-white">Get paid on the spot—your money is transferred directly to your bank account with confirmation before you leave.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
