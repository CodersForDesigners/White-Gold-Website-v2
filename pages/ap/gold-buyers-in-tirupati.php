...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-tirupati.php';
...
<h2 class="pb-4">8 Simple Steps to Release Your Gold Loan</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Carry a Valid Photo ID <span class="text-white">Have your Aadhaar, Passport, or any government-issued ID ready for fast and secure KYC verification.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Visit a White Gold Branch<span class="text-white">To sell gold in Tirupati, visit your nearest White Gold branch — our team is ready to assist you throughout the process.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Complete KYC & Security Verification <span class="text-white">We will verify your identity and address with a quick phone call to ensure added security.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Check the Live Gold Rate <span class="text-white">Your gold’s value is based on real-time market rates and accurate purity checks.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Close Your Gold Loan <span class="text-white">After verification, we will finalize your loan closure with full transparency.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Confirm Your Gold’s Purity <span class="text-white">Our advanced XRF machines conduct a precise, tamper-proof, and non-destructive purity check.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Payment Transfer <span class="text-white">Receive immediate payment via direct bank transfer, with confirmation before you leave the branch.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<div class="container">
    <div class="text-center mt-3 mb-4"><h2>Why White Gold is the Smart Choice for Selling Your Gold</h2></div>
