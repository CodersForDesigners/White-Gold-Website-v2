...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-vijayawada.php';
...
?>
<?php require_once __ROOT__ . '/pages/section/header-ap.php'; ?>
...
<?php require_once __ROOT__ . '/pages/section/includes-lp/menu-below-slider-ap.php'; ?>

<!-- Sell Gold Form Section -->
<?php require_once __ROOT__ . '/pages/section/includes-lp/lp-form-ap.php'; ?>
...
<h2 class="pb-4">Releasing Your Pledged Gold? We Make It Simple in 8 Easy Steps</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<img src="/cms/../content/cms/whitegold-andhra-img.png" class="img-fluid pt-5">
</div><!--
<!-- col end -->
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Receipt <span class="text-white">Ensure you have the original receipt to help us quickly verify and process your gold release.</span></h4>
...
<h4 class="text-white">Carry a Valid Photo ID <span class="text-white">Prepare your Aadhaar, Passport, or any government issued ID for fast and secure KYC verification.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Visit a White Gold Branch<span class="text-white">Head to the nearest White Gold branch—our team is here to assist you every step of the way.
</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Complete KYC & Safety Verification <span class="text-white">We will validate your identity and address and do a quick phone check for added security.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Check the Live Gold Rate   <span class="text-white">Your gold’s value is based on live market rates and precise purity verification—no surprises.
</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Close Your Gold Loan   <span class="text-white">Once all details are verified, we will finalize your loan closure with complete transparency.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Confirm Your Gold’s Purity <span class="text-white">Our advanced XRF machines provide a precise, non-damaging, and tamper-proof purity check.
</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Payment Transfer  <span class="text-white">Receive immediate payment through a direct bank transfer, with confirmation before you leave the branch.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<div class="container">
    <div class="text-center mt-3 mb-4"><h2>The Smart Way to Sell Gold for Cash in Vijayawada</h2></div>
...
<img src="/cms/../content/cms/Group.svg" class="img-fluid mb-2" alt="Technology Driven logo" title="Technology Driven"><p class="mt-1">Tech-Driven Processes</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-1.svg" class="img-fluid mb-2" alt="Wide Network Of Branches icon" title="Wide Network Of Branches"><p class="mt-1">Extensive Branch Network</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-2.svg" class="img-fluid mb-2" alt="Professional Team icon" title="Professional Team"><p class="mt-1">Expert, Professional Team</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-3.svg" class="img-fluid mb-2" alt="Complaint Redressal System icon" title="Complaint Redressal System"><p class="mt-1">Dedicated Complaint Redressal</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-4.svg" class="img-fluid mb-2" alt="White Group Conglomerate icon" title="White Group Conglomerate"><p class="mt-1">Part of the White Group Conglomerate</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-5.svg" class="img-fluid mb-2" alt="Live Gold Rate - White Gold" title="Live Gold Rate"><p class="mt-1">Live Gold Rates</p>
</div></div>
<!-- box ends --></div>
</div>
