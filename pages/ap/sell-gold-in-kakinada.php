...
<h2 class="pb-4">Release Gold in Kakinada in 8 Simple Steps</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Receipt <span class="text-white">Carry your original pledge receipt to help our team verify your details quickly and begin the pledged gold release in Kakinada process.</span></h4>
...
<h4 class="text-white">Provide a Valid Photo ID <span class="text-white">Provide your Aadhaar, Passport, or any authorized ID for quick and secure KYC verification.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Visit White Gold Kakinada<span class="text-white">Walk into our nearby branch to sell gold in Kakinada or start your release request. Our staff will assist you every step of the way.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Complete KYC and Verification <span class="text-white">We confirm your identity and contact details instantly to ensure full transaction security.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Check the Live Gold Rate  <span class="text-white">Your gold’s value is calculated using real time market rates so you get the highest possible return.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Close Your Gold Loan  <span class="text-white">Our team coordinates directly with the lender to settle your outstanding balance on the spot.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Test Purity and Weight <span class="text-white">We use advanced XRF technology to check purity and weight in your presence, transparent and precise.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Get Instant Bank Transfer <span class="text-white">After the gold is released, payment is made directly to your account, fast and smooth with gold buyers in Kakinada.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
