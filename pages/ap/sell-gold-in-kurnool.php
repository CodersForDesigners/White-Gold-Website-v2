...
<h2 class="pb-4">Release Gold in Kurnool in 8 Simple Steps</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Carry Your Pledge Receipt <span class="text-white">Bring your original pledge receipt to help us quickly verify details and ensure a smooth pledged gold release in Kurnool.</span></h4>
...
<h4 class="text-white">Visit the White Gold Branch<span class="text-white">To sell gold in Kurnool, walk into our White Gold branch where our expert team will guide you at every step.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Complete KYC and Security Checks <span class="text-white">We verify your identity and address effectively with a phone call confirmation for added safety during the release gold in Kurnool process.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Receive Instant Payment <span class="text-white">The agreed amount is transferred securely to your bank account. We make your pledged gold release in Kurnool fast and hassle free.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
