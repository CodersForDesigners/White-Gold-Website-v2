...
<h2 class="pb-4">Release Gold in Nellore in 8 Simple Steps</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Receipt <span class="text-white">Carry your original pledge receipt to help our team verify your details quickly and begin the pledged gold release in Nellore process.</span></h4>
...
<h4 class="text-white">Provide a Valid Photo ID <span class="text-white">Provide your Aadhaar, Passport, or any government issued ID for fast and secure KYC verification.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Visit White Gold Nellore<span class="text-white">Walk into our branch to sell gold in Nellore or start your gold release request. Our experts will guide you step by step.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Complete KYC and Verification <span class="text-white">We confirm your identity and contact details instantly to ensure a safe and transparent process.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Check the Live Gold Rate  <span class="text-white">Your gold’s value is calculated using real time market rates, ensuring you get the most accurate and fair price.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Close Your Gold Loan  <span class="text-white">Our team coordinates directly with the lender to settle your outstanding balance quickly.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Test Purity and Weight <span class="text-white">Advanced XRF technology verifies the purity and weight of your gold in your presence, guaranteeing transparency.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Get Instant Bank Transfer <span class="text-white">After the gold is released, the agreed payment is transferred directly to your bank account, fast and safe.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
