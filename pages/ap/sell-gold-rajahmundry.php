...
<h2 class="pb-4">8 Easy Steps to Release Gold in Rajahmundry</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Receipt <span class="text-white">Carry your original pledge slip. So we can quickly verify and start the release gold Rajahmundry process.</span></h4>
...
<h4 class="text-white">Carry a Valid Photo ID <span class="text-white">Aadhaar, Passport, or any government ID works, needed for secure KYC.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Visit Our Rajahmundry Branch<span class="text-white">Drop by the nearest White Gold store to sell gold in Rajahmundry or release pledged gold easily.
</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Quick KYC & Safety Check <span class="text-white">We will verify your details and make a short verification call to a family member, just for added security.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Know the Live Gold Rate   <span class="text-white">We show you the current gold price before any action. No surprises, just fair value.
</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Close the Gold Loan   <span class="text-white">We settle the loan directly with the lender. You don’t need to deal with the bank.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Gold Purity Test On-Spot <span class="text-white">We test your gold with high accuracy XRF machines. No damage, no delays.
</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Bank Transfer <span class="text-white">After all is done, your money is sent directly to your account.
</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<div class="container">
    <div class="text-center mt-3 mb-4"><h2>White Gold - The Smart Choice to Sell Gold in Rajahmundry</h2></div>
...
<img src="/cms/../content/cms/Group.svg" class="img-fluid mb-2" alt="Technology Driven logo" title="Technology Driven"><p class="mt-1">Accurate Purity Testing</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-6 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-1.svg" class="img-fluid mb-2" alt="Wide Network Of Branches icon" title="Wide Network Of Branches"><p class="mt-1">60+ Branches Across South India</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-6 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-2.svg" class="img-fluid mb-2" alt="Professional Team icon" title="Professional Team"><p class="mt-1">Trained Staff & Transparent Process</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-6 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-3.svg" class="img-fluid mb-2" alt="Complaint Redressal System icon" title="Complaint Redressal System"><p class="mt-1">Quick Support System</p>
</div></div>
<!-- box ends -->
