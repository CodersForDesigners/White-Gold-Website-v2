...
<style>
.lp-hoskote .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 126%;
    z-index: 1;
}
.lp-hoskote .highlight .slick-next {
    position: absolute;
    top: 126%;
    right: 36%;
    z-index: 1;
}
.lp-hoskote .highlight .slick-dots {
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "serviceType": "Gold Buyers in Hoskote, Sell Gold for Cash in Hoskote",
  "provider": {
    "@type": "Organization",
    "name": "White Gold"
  },
  "areaServed": "Hoskote",
  "mainEntityOfPage": "https://whitegold.money/ka/gold-buyers-in-hoskote"
}
</script>
