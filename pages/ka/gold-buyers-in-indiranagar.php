...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-indiranagar.php';
...
<style>
    .lp-indiranagar .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 137%;
    z-index: 1;
}
.lp-indiranagar .highlight .slick-next {
    position: absolute;
    top: 137%;
    right: 36%;
    z-index: 1;
}
.lp-indiranagar .highlight .slick-dots {
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "serviceType": "Gold Buyers in Indiranagar, Sell Gold for Cash in Indiranagar",
  "provider": {
    "@type": "Organization",
    "name": "White Gold"
  },
  "areaServed": "Indiranagar",
  "mainEntityOfPage": "https://whitegold.money/ka/gold-buyers-in-indiranagar"
}
</script>
