...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-jalahalli.php';
...
<h2>How to Exchange Old Gold Jewelry in Jalahalli?</h2>
</div>
<div class="row d-flex">
<div class="columns small-12 large-6 align-self-center">
    <p class="text-sml-center">Want to sell gold in Jalahalli? The most effective way to convert your valuable gold jewelry is by identifying dependable <a href="https://whitegold.money/ka"> gold buyers </a> in Jalahalli. </p>
    <p class="pt-4">Choose White Gold for:</p>
<ul class="pt-4">
<li>Clear transparency in the cash-for-gold process in Jalahalli.</li>
...
<img src="/cms/../content/cms/Group-4211-3-1.png" class="img-fluid" alt="Gold Buyers">
</div>
</div>
</div>
</section>
...
<img src="https://whitegold.money/cms/../content/cms/Group-4189-1-2.png" class="img-fluid" alt="sell-gold" title="">
</div>
...
@media screen and (max-width: 980px){
    .lp-jalahalli .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 220%;
    z-index: 1;
}
.lp-jalahalli .highlight .slick-next {
    position: absolute;
    top: 220%;
    right: 35%;
    z-index: 1;
