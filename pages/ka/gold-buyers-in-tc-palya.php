...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-tc-palya.php';
...
<h2>How to Exchange Old Gold Jewelry in TC Palya?</h2>
</div>
<div class="row d-flex">
<div class="columns small-12 large-6 align-self-center">
    <p class="text-sml-center">Want to <a href="https://whitegold.money/where-to-sell-gold-in-bangalore-to-get-the-best-value"> sell gold</a> in TC Palya? The most effective way to convert your valuable <a href="https://whitegold.money/how-to-efficiently-sell-your-gold-jewellery-in-bangalore"> gold jewelry</a> is by identifying dependable <a href="https://whitegold.money/ka"> gold buyers </a> in TC Palya. </p>
    <p class="pt-4">Choose White Gold for:</p>
<ul class="pt-4">
<li>Clear transparency in the cash-for-gold process in TC Palya.</li>
...
@media screen and (max-width: 980px){
    .lp-tc-palya .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 240%;
    z-index: 1;
}
.lp-tc-palya .highlight .slick-next {
    position: absolute;
    top: 240%;
    right: 35%;
    z-index: 1;
...
.lp-tc-palya .highlight .slick-dots {
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "serviceType": "Gold Buyers in TC Palya, Sell Gold for Cash in TC Palya",
  "provider": {
    "@type": "Organization",
    "name": "White Gold"
  },
  "areaServed": "TC Palya",
  "mainEntityOfPage": "https://whitegold.money/ka/gold-buyers-in-tc-palya/"
}
</script>
