...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/sell-gold-in-mandya.php';
...
<h2>Exploring Options to Exchange Old Gold Jewelry in Mandya?</h2>
</div>
<div class="row d-flex">
<div class="columns small-12 large-6 align-self-center">
    <p class="text-sml-center">Are you considering selling gold in Mandya? Choose reputable<a href="https://whitegold.money/how-to-sell-gold-and-get-the-best-value-with-white-gold/"> gold buyers</a> in Mandya for the optimal transformation of your precious gold jewelry. </p>
    <p class="pt-4">Select White Gold for:</p>
<ul class="pt-4">
<li>Clear and transparent management of the gold selling procedure in Mandya.</li>
<li>Employment of advanced testing techniques for precise and reliable results.
</li>
<li>Adherence to current market rates for accurate evaluation of gold values.</li>
<li>A simplified process, immediate payment, and an enhanced customer experience.</li>
...
<div class="container">
    <div class="text-center mt-3 mb-4"><h2>Why Sell to White Gold ?</h2></div>
...
<img src="https://whitegold.money/cms/../content/cms/Group-1.svg" class="img-fluid mb-2" alt="Wide Network Of Branches icon" title="Wide Network Of Branches"><p class="mt-1">Extensive <a href="https://whitegold.money/ka/branches"> Branch</a> Network</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
...
<img src="https://whitegold.money/cms/../content/cms/Group-5.svg" class="img-fluid mb-2" alt="Live Gold Rate - White Gold" title="Live Gold Rate"><p class="mt-1"><a href="https://whitegold.money/ka/live-gold">Live Gold Rate</a></p>
</div></div>
<!-- box ends --></div>
</div>
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "serviceType": "Gold Buyers in Mandya, Sell Gold for Cash in Mandya",
  "provider": {
    "@type": "Organization",
    "name": "White Gold"
  },
  "areaServed": "Mandya",
  "mainEntityOfPage": "https://whitegold.money/ka/sell-gold-in-mandya"
}
</script>
