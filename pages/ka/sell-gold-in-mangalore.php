...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/sell-gold-in-mangalore.php';
...
<style> 
@media screen and (max-width: 980px){
    .lp-kanakapura-road .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 300%;
    z-index: 1;
}
.lp-kanakapura-road .highlight .slick-next {
    position: absolute;
    top: 300%;
    right: 35%;
    z-index: 1;
...
.lp-kanakapura-road .highlight .slick-dots {
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "serviceType": "Gold Buyers in Mangalore, Sell Gold for Cash in Mangalore",
  "provider": {
    "@type": "Organization",
    "name": "White Gold"
  },
  "areaServed": "Mangalore",
  "mainEntityOfPage": "https://whitegold.money/ka/sell-gold-in-mangalore"
}
</script>
