<?php
/**
 * The template for displaying for thankyou page ORIGINAL
 *
...
<div class="main-menu columns small-12 medium-6 medium-offset-3 large-12 large-offset-0 fill-dark radius-50 js_whatsapp_form_section js_main_menu" bis_skin_checked="1">
	<div class="row" bis_skin_checked="1">
		...
		<div class="menu-content columns small-12 large-9" bis_skin_checked="1">
			<div class="row space-25" bis_skin_checked="1">
				...
				<div class="columns small-6 large-3 space-25" bis_skin_checked="1">
					<a class="menu-button block fill-blue-5" href="tel:+919562262222">Sell Gold</a>
				</div>
				<div class="columns small-6 large-3 space-25" bis_skin_checked="1">
					<a class="menu-button block fill-light" href="tel:+919562262222">Release Gold</a>
				</div>
			</div>
		</div>
		<!-- Menu Controls -->
		<div class="menu-head columns small-12 large-3" bis_skin_checked="1">
			<div class="row space-25" bis_skin_checked="1">
				<div class="toggle-whatsapp columns small-2 large-3 space-25" bis_skin_checked="1" onclick="window.location.href='https://api.whatsapp.com/send/?phone=%2B918884303333&text&type=phone_number&app_absent=0'" style="cursor: pointer;">
				...
				<div class="phone-number columns small-6 small-offset-1 large-9 large-offset-0 space-25" bis_skin_checked="1">
					<a class="menu-button block fill-neutral-5 text-center" href="tel:+919562262222">+91 95622 62222</a>
				</div>
...
<section class="ads-lp-banner fill-blue-5">
    ...
    <img src="https://whitegold.money/cms/../content/cms/kl-ads-1.png" class="img-fluid w-md-300 w-sm-320 d-lg-none d-md-none d-tab-none"></div>
    <div class="text-right text-sm-center">
    <img src="https://whitegold.money/cms/../content/cms/kl-ads-1.png" class="img-fluid w-sm-250 d-none d-md-block mx-md-ld-auto"></div>
...
<a class="btn-custom-primary mt-4" style="color: #000 !important;background-color:#fff!important;" target="_self" href="tel:+919562262222">Sell your Gold now</a>
</div>
...
<div class="section1">
<div class="row">
<div class="columns small-12 large-5 text-center text-lg-left"><img class="img-fluid pb-5 w-sm-250" src="https://whitegold.money/cms/../content/cms/kl-ads-3.png"></div>
...
<p class="p align-self-center">A trusted name across South India, now serving families in Kerala.</p>
</div>
</div>
<div class="columns small-12 medium-6 large-6 mt-2 mb-5">
<div class="d-flex">
...
<img src="https://whitegold.money/cms/../content/cms/kl-ads-4.png" class="img-fluid d-lg-none d-md-none">
...
<p class="text-white"> <span class="text-yellow-2"> 350+ </span> Employees</p>
</div>

</div>
<div class="col-lg-4 align-self-end">
 <img src="https://whitegold.money/cms/../content/cms/kl-ads-4.png" class="img-fluid d-none d-md-block d-tab-none">
</div>
...
<!-- get money starts -->
<section class="space-200-top-bottom get-money">
<div class="container">
  <div class="text-center">
<h2>We buy your gold at the right price - no hidden charges-100% transparency. </h2>
<a class="btn-custom-primary mt-4" style="background-color: var(--blue-5) !important;
    color: #ffffff !important;" target="_self" href="tel:+919562262222">Sell your Gold now</a>
</div>
...
@media screen and (min-width: 767px){
  ...
  .ads-lp-banner h1{font-size:48px;font-weight: 600;display:block;text-transform: capitalize;}
