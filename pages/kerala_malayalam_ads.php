...
<section class="ads-lp-banner fill-blue-5">
    ...
    <h1 class="d-lg-none d-md-none d-tab-none text-center">താങ്കളുടെ സ്വർണത്തിന് യഥാർത്ഥ മൂല്യം ഉടൻ ലഭിയ്ക്കൂ – വൈറ്റ് ഗോൾഡിൽ</h1>
    <h1 class="d-none d-md-block">താങ്കളുടെ സ്വർണത്തിന് യഥാർത്ഥ മൂല്യം ഉടൻ ലഭിയ്ക്കൂ – വൈറ്റ് ഗോൾഡിൽ</h1>
    ...
    <img src="/content/cms/5K8A6755-1-1.png" class="img-fluid w-md-300 w-sm-320 d-lg-none d-md-none d-tab-none"></div>
    <div class="text-right text-sm-center">
    <img src="/content/cms/5K8A6755-1.png" class="img-fluid w-sm-250 d-none d-md-block mx-md-ld-auto"></div>
...
<h2>ഞങ്ങൾ നിങ്ങളുടെ സ്വർണം ശരിയായ വിലയ്ക്ക് വാങ്ങുന്നു - ഒളിപ്പിച്ച ചിലവുകളില്ല - 100% പ്രകടത്വം</h2>
...
<img src="/content/cms/5K8A6826-2.png" class="img-fluid d-lg-none d-md-none">
...
<div class="col-lg-4 align-self-end">
 <img src="/content/cms/5K8A6826-2.png" class="img-fluid d-none d-md-block d-tab-none">
</div>
