...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-chavakkad.php';
...
@media screen and (max-width: 980px){
    .lp-chavakkad .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 219%;
    z-index: 1;
}
.lp-chavakkad .highlight .slick-next {
    position: absolute;
    top: 219%;
    right: 35%;
    z-index: 1;
...
.lp-chavakkad .highlight .slick-dots {
