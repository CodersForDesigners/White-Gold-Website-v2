...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-edapally.php';
...
@media screen and (max-width: 980px){
    .lp-edappally .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 236%;
    z-index: 1;
}
.lp-edappally .highlight .slick-next {
    position: absolute;
    top: 236%;
    right: 35%;
    z-index: 1;
...
.lp-edappally .highlight .slick-dots {
