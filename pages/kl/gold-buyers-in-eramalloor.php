...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-eramalloor.php';
...
@media screen and (max-width: 980px){
    .lp-eramallor .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 205%;
    z-index: 1;
}
.lp-eramallor .highlight .slick-next {
    position: absolute;
    top: 205%;
    right: 35%;
    z-index: 1;
...
.lp-eramallor .highlight .slick-dots {
