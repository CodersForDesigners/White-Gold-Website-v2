...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-kattappana.php';
...
@media screen and (max-width: 980px){
    .lp-kattappana .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 235%;
    z-index: 1;
}
.lp-kattappana .highlight .slick-next {
    position: absolute;
    top: 235%;
    right: 35%;
    z-index: 1;
...
.lp-kattappana .highlight .slick-dots {
