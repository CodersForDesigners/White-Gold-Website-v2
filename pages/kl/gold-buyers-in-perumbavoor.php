...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-perumbavoor.php';
...
@media screen and (max-width: 980px){
    .lp-perumbavoor .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 270%;
    z-index: 1;
}
.lp-perumbavoor .highlight .slick-next {
    position: absolute;
    top: 270%;
    right: 35%;
    z-index: 1;
...
.lp-perumbavoor .highlight .slick-dots {
