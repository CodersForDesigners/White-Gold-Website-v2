...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-thodupuzha.php';
...
@media screen and (max-width: 980px){
    .lp-thodupuzha .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 260%;
    z-index: 1;
}
.lp-thodupuzha .highlight .slick-next {
    position: absolute;
    top: 260%;
    right: 35%;
    z-index: 1;
...
.lp-thodupuzha .highlight .slick-dots {
