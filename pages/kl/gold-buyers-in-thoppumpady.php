...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-thoppumpady.php';
...
<?php require_once __ROOT__ . '/pages/section/includes-lp/report-malpractice-kl.php'; ?>
...
@media screen and (max-width: 980px){
    .lp-thoppumpady .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 220%;
    z-index: 1;
}
.lp-thoppumpady .highlight .slick-next {
    position: absolute;
    top: 220%;
    right: 35%;
    z-index: 1;
...
.lp-thoppumpady .highlight .slick-dots {
