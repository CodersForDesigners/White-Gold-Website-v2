...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ka/gold-buyers-in-thrissur.php';
...
@media screen and (max-width: 980px){
    .lp-thrissur .highlight .slick-prev {
    position: absolute;
    left: 35%;
    top: 215%;
    z-index: 1;
}
.lp-thrissur .highlight .slick-next {
    position: absolute;
    top: 215%;
    right: 35%;
    z-index: 1;
...
.lp-thrissur .highlight .slick-dots {
