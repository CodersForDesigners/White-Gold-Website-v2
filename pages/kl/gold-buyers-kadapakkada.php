...
<h2 class="pb-4">Quick Guide to release gold in Kadapakkada - 8 Easy Steps</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Receipt <span class="text-white">Carry your original pledge receipt to help us quickly verify and process release gold in Kadapakkada.</span></h4>
...
<h4 class="text-white">Visit a White Gold Branch<span class="text-white">To sell gold in Kerala, visit your nearest White Gold branch. Our team will assist you throughout the process.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Complete KYC & Security Verification <span class="text-white">We verify your identity and address with a quick phone call for added security</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Close Your Gold Loan  <span class="text-white">After verification, we finalize your gold loan closure with full transparency and clarity.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Confirm Your Gold’s Purity <span class="text-white">Advanced XRF machines perform a non destructive purity check for accuracy</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Payment Transfer <span class="text-white">Receive immediate payment via direct bank transfer, with confirmation.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
