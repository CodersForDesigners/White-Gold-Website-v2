...
<h2 class="pb-4">Release Your Gold Loan Made Simple With 8 Easy Steps</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Receipt <span class="text-white">Carry your original pledge receipt to help us verify and process your gold loan release quickly.</span></h4>
...
<h4 class="text-white">Carry a Valid Photo ID <span class="text-white">Keep your Aadhaar, Passport, or any government issued ID handy for smooth and secure KYC verification.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Visit a White Gold Branch<span class="text-white">To release gold in Kayamkulam, walk into your nearest White Gold branch. Our professional team will guide you throughout the process.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Complete KYC & Security Verification <span class="text-white">We will verify your identity and address with a quick confirmation call for added security.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Check the Live Gold Rate  <span class="text-white">Your gold value is calculated based on the real time market rate and purity check.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Close Your Gold Loan  <span class="text-white">After the verification, your loan will be closed with complete transparency and clarity.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Confirm Your Gold’s Purity <span class="text-white">Our XRF machines conduct a 100% accurate, tamper proof, and non-destructive purity test.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Payment Transfer <span class="text-white">Receive your money instantly via bank transfer, confirmed before you leave the branch.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
