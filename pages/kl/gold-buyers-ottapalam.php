...
<h2 class="pb-4">8 Quick Steps to Release Gold in Ottapalam</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Carry a Valid Photo ID <span class="text-white">Keep your Aadhaar, Passport, or any government issued ID ready for fast KYC verification.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Visit a White Gold Branch<span class="text-white">To release gold in Ottapalam, visit your nearest White Gold branch where our team is ready to assist you</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Close Your Gold Loan  <span class="text-white">After verifying everything, your loan closure is finalized with complete transparency.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
