...
<h2 class="pb-4">8 Simple Steps to Release gold in Palakkad</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Receipt <span class="text-white">Have the original receipt with you. It will help us quickly verify and process your gold loan release.</span></h4>
...
<h4 class="text-white">Visit a White Gold Branch<span class="text-white">To release gold in Palakkad, visit your nearest White Gold branch where our team is ready to assist you.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Close Your Gold Loan  <span class="text-white">After verification, your loan closure is finalized with complete transparency.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Payment Transfer <span class="text-white">Receive immediate payment via bank transfer for a hassle free experience when you sell gold in Kerala.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
