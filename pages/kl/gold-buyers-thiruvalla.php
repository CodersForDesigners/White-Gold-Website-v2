...
<h2 class="pb-4">8 Quick Steps to Release Your Gold Loan</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Receipt <span class="text-white">Carry your original pledge receipt so our team can quickly verify and start the process to release gold in Thiruvalla.</span></h4>
...
<h4 class="text-white">Carry a Valid Photo ID <span class="text-white">Keep your Aadhaar, Passport, or any government approved ID ready for a fast KYC check.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Visit a White Gold Branch<span class="text-white">Walk into our Thiruvalla branch and get expert guidance if you want to release or sell gold in Kerala.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Complete KYC & Security Verification <span class="text-white">Our team verifies your details with a quick phone call for added safety.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Check the Live Gold Rate  <span class="text-white">We calculate your gold value using real time market prices for complete transparency.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Close Your Gold Loan  <span class="text-white">After the verification is complete, we proceed with loan closure in a simple and clear process.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Confirm Your Gold’s Purity <span class="text-white">With advanced XRF machines, we ensure 100% accurate, non-destructive purity testing.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Payment Transfer <span class="text-white">Receive the best value for your gold via immediate bank transfer before leaving the branch, fast and safe.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
