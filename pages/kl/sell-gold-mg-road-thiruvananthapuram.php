...
<h2 class="pb-4">Release Gold in MG Road Quickly With Just 8 Steps</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Receipt <span class="text-white">Carry the original receipt of your pledged gold for smooth verification.</span></h4>
...
<h4 class="text-white">Visit White Gold Branch <span class="text-white">Meet our expert staff who handle the entire process securely.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Loan Verification <span class="text-white">We verify your loan directly with the bank or financier.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Confirm Outstanding Amount <span class="text-white">Our team calculates the exact amount needed for closure.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Clear the Loan  <span class="text-white">White Gold ensures dues are cleared quickly and transparently.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Gold Collection  <span class="text-white">We collect your pledged gold safely and securely from the lender.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Confirm Your Gold’s Purity <span class="text-white">Every piece of gold is tested with advanced machines for accuracy.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Payment Transfer <span class="text-white">You can sell gold in MG Road with us and immediately receive payment via secure transfer.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
