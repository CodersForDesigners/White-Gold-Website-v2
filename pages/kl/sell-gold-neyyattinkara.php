...
<h2 class="pb-4">8 Simple Steps with White Gold to Release Gold in Neyyattinkara</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Receipt <span class="text-white">Carry the original receipt of your pledged gold for quick verification.</span></h4>
...
<h4 class="text-white">Visit White Gold Branch <span class="text-white">Walk into our branch and share your gold loan details with our team.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Loan Verification <span class="text-white">We directly verify your loan with the respective bank or financier.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Confirm Outstanding Amount <span class="text-white">Our staff calculates the exact amount needed for loan closure.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Clear the Loan  <span class="text-white">White Gold clears the dues on your behalf quickly and transparently.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Gold Collection  <span class="text-white">We collect your pledged ornaments safely from the loan provider.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Confirm Your Gold’s Purity <span class="text-white">Every piece of gold is tested in front of you with 100% accuracy.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Payment Transfer <span class="text-white">You can sell gold in Neyyattinkara immediately and receive payment through secure bank transfer, making the process smooth.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
