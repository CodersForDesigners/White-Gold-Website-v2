...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/kl/sell-gold-pala';
...
<h2 class="pb-4">Want to Release Pledged Gold in Pala? Follow These Simple 8 Steps</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Slip <span class="text-white">To start, just carry your original pledge receipt. It helps us verify your gold loan details with the lender.</span></h4>
...
<h4 class="text-white">Carry a Valid ID <span class="text-white">Keep your Aadhaar card or any government issued photo ID ready for KYC. It is quick and essential.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Walk into a White Gold Branch in Pala<span class="text-white">Visit our nearest branch in Pala. Our gold loan experts will guide you through every step of the release process.
</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Quick KYC <span class="text-white">We will do a short ID verification and a confirmation call to a family member for added security.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Check the Live Gold Rate in Pala   <span class="text-white">Before proceeding, we will show you the current market rate. We are committed to fair and real time pricing.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">On the Spot Gold Purity Test <span class="text-white">Your released jewellery is tested in front of you using non-invasive XRF technology for purity and weight.
</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Get Paid Instantly  <span class="text-white">After the value is confirmed, we will transfer the agreed amount directly to your bank account, safely and smoothly.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<div class="container">
    <div class="text-center mt-3 mb-4"><h2>Why Thousands Trust White Gold to Sell Their Gold</h2></div>
    <div class="row mt-5-xl">
<div class="columns small-12 large-5">
<img src="/content/cms/why-whitegold-kerala.png" class="img-fluid" alt="sell-gold" title="">
</div>
...
<img src="/cms/../content/cms/Group.svg" class="img-fluid mb-2" alt="Technology Driven logo" title="Technology Driven"><p class="mt-1">Technology-Driven Processes</p>
</div></div>
...
<img src="/cms/../content/cms/Group-2.svg" class="img-fluid mb-2" alt="Professional Team icon" title="Professional Team"><p class="mt-1">Experienced & Professional Team</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-3.svg" class="img-fluid mb-2" alt="Complaint Redressal System icon" title="Complaint Redressal System"><p class="mt-1">Strong Complaint Redressal System</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
...
<img src="/cms/../content/cms/Group-5.svg" class="img-fluid mb-2" alt="Live Gold Rate - White Gold" title="Live Gold Rate"><p class="mt-1">Live Gold Rate Transparency</p>
</div></div>
<!-- box ends --></div>
</div>
