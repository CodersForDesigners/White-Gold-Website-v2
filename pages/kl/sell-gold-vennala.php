...
<h2 class="pb-4">8 Easy Steps to Release Gold in Vennala</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Receipt <span class="text-white">To release gold in vennala, have the original pledge receipt with you. It helps us quickly verify and speed up the gold release process.</span></h4>
...
<h4 class="text-white">Visit White Gold Branch <span class="text-white">Aadhaar card, Passport, or any government ID works for quick and secure KYC verification.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Loan Verification <span class="text-white">To sell gold in Vennala, just walk into our branch. Our staff are always ready to guide you.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Confirm Outstanding Amount <span class="text-white">Your identity and address are verified with a quick phone confirmation for added safety.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Clear the Loan  <span class="text-white">We use live MCX rates, so you always know the exact and fair value of your gold.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Gold Collection  <span class="text-white">After the verification, we will close your loan fully transparently.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Confirm Your Gold’s Purity <span class="text-white">Our XRF machines ensure accurate and tamper proof. We ensure non destructive purity testing.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Payment Transfer <span class="text-white">The agreed amount is sent directly to your bank account before you leave.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
