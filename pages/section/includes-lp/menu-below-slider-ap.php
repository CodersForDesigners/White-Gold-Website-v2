...
<div class="main-menu columns small-12 medium-6 medium-offset-3 large-12 large-offset-0 fill-dark radius-50 js_whatsapp_form_section js_main_menu" bis_skin_checked="1">
	<div class="row" bis_skin_checked="1">
		...
		<input id="toggle-menu-open-home" type="checkbox" aria-label="toogle-menu" name="toggle-menu-open" class="toggle-menu-open visuallyhidden js_primary_toggle_menu">
		<!-- Whatsapp Switcher Checkbox -->
		<input id="toggle-whatsapp-open-home" type="checkbox" name="toggle-whatsapp-open" class="toggle-whatsapp-open visuallyhidden js_wa_toggle_menu">
		<!-- Menu Content -->
		<div class="menu-content columns small-12 large-9" bis_skin_checked="1">
			<div class="row space-25" bis_skin_checked="1">
				<div class="columns small-6 large-4 space-25" bis_skin_checked="1">
					<a class="menu-button menu-button-large block fill-blue-4" href="/ap/branches">
				...
				<div class="columns small-6 large-4 space-25" bis_skin_checked="1">
					<a class="menu-button menu-button-large block fill-yellow-2 text-light" href="/ap/live-gold">
				...
				<div class="columns small-6 large-2 space-25" bis_skin_checked="1">
					<a class="menu-button block fill-blue-5" href="/ap#sell-gold-section">Sell Gold</a>
				</div>
				<div class="columns small-6 large-2 space-25" bis_skin_checked="1">
					<a class="menu-button block fill-light" href="/ap#release-gold-section">Release Gold</a>
				</div>
			</div>
		</div>
		<!-- Menu Controls -->
		<div class="menu-head columns small-12 large-3" bis_skin_checked="1">
			<div class="row space-25" bis_skin_checked="1">
				<div class="toggle-whatsapp columns small-2 large-3 space-25" bis_skin_checked="1">
					<label class="menu-button block fill-neutral-5" style="--bg-image: url( '/media/icon/vertical-dots.white.svg' ); background-color: #32AF74;" for="toggle-whatsapp-open-home" alt="whatsapp">
						<span class="l1"></span>
						<span class="l2"></span>
				...
				<div class="phone-number columns small-6 small-offset-1 large-9 large-offset-0 space-25" bis_skin_checked="1">
					<a class="menu-button block fill-neutral-5 text-center" href="tel:+918884303333">+91 888 430 3333</a>
				</div>
				<div class="toggle-menu columns small-2 small-offset-1 large-3 large-offset-0 space-25 hide-large hide-xlarge" bis_skin_checked="1">
					<label class="menu-button block fill-neutral-5" style="--bg-image: url( '/media/icon/vertical-dots.white.svg' )" for="toggle-menu-open-home" alt="whitegold gold near me">
						<span class="l1"></span>
						<span class="l2"></span>
						<span class="l3"></span>
					</label>
		...
		<div class="whatsapp-form fill-dark columns small-12 large-4" bis_skin_checked="1">
			<div class="" bis_skin_checked="1">
				<form class="form-card form-dark row space-25 js_whatsapp_form" onsubmit="event.preventDefault()" data-number="+91 95903 04444">
					...
					<div class="columns small-10 space-25" bis_skin_checked="1">
						<label class="phone-verify form-label block">
							<input type="text" class="form-input-field phone-number block js_form_input_phone_number" _id="js_home_visit_form_input_phone_home">
...
<option value="zw +263">
	Zimbabwe (+263)
							...
							<input type="text" disabled="" class="form-input-field country-code-label js_phone_country_code_label" value="+91" _id="js_home_visit_form_input_phone_country_code_home">
