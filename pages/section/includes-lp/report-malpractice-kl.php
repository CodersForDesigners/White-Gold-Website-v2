...
<section class="report-malpractice-section pt-200 fill-dark" id="report-malpractice-section" data-section-title="Report Malpractice Section" data-section-slug="report-malpractice-section">
	<div class="container">
		<div class="row">
			...
			<div class="relative mt-100 columns small-12 medium-7 large-8 overflow-hidden">
					...
					<div class="columns small-12 large-10">
						<div class="columns small-7 large-5 mt-50">
							<a href="/<?= REGION ?>/live-gold" class="relative inline-flex w-full px-50 py-50 h6 fill-yellow-2 text-light radius-25 overflow-hidden">
								...
								<img class="relative inline-block w-50" src="/media/icon/rupee-white.svg<?php echo $ver ?>">
				...
				<div class="fg-img-container row">
					<div class="fg-img absolute"><img class="" style="" src="/content/cms/check-gold-rate.png<?php echo $ver ?>"></div>
				</div>
				<div class="row mt-50">
