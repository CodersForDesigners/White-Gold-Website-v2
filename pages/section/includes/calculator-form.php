	...
	<div class="container">
		<div class="row sell-gold-form">
			<div class="columns small-6 medium-5 large-4 space-100-bottom">
				...
				<div class="h2 line-height-small">Not sure about your Gold weight? Let us help you.</div>
			</div>
		...
		<div class="char"><img class="block" src="/media/cutout/2023/char-pointing-up.png?<?php echo $ver ?>"></div>
	</div>
</section>
<style>
