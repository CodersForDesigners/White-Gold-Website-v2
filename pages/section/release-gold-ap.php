<section class="release-gold-section fill-neutral-1 space-200-top-bottom js_section_release_gold ap-ts-faq-accor" id="release-gold-section" data-section-title="Release Gold Section" data-section-slug="release-gold-section">
	<div class="container">
		<div class="row">
				...
				<div class="step-card-grid row">
					...
					<div class="card rgs2 columns small-12 fill-light">
						...
						<div class="card-content px-50">
							...
							<div class="bg-img"><img class="block" src="/content/cms/ap-ts-pledge-gold-guy.png<?php echo $ver ?>" alt="where can i sell gold for cash near me" title="where can i sell gold for cash near me"></div>
						</div>
					</div>
					<!-- CARD: 3 -->
					<div class="card rgs3 columns small-12 fill-light">
						...
						<div class="card-content px-50">
							...
							<div class="bg-img"><img class="block" style="padding-left:20px;" src="/cms/../content/cms/id-proof-ap-ts.png<?php echo $ver ?>" alt="best place to sell gold jewelry for cash near me" title="best place to sell gold jewelry for cash near me"></div>
						</div>
					</div>
					<!-- CARD: 1 -->
						...
						<div class="card-content px-50">
							<div class="row">
								<div class="columns small-9 small-offset-1 space-50-left-right space-50-bottom">
									...
									<div class="mt-25 h5 medium" style="text-shadow: 1px 1px 1px rgba(0,0,0,0.15)">Across Karnataka, Andhra Pradesh,<br>Kerala and<br> Telangana</div>
							...
							<div class="bg-img"><img class="block" style="padding-left:30px;" src="/cms/../content/cms/branches-ts-ap.png<?php echo $ver ?>" alt="best place to sell gold near me" title="best place to sell gold near me">  </div>
						</div>
					</div>
					...
					<div class="card rgs5 columns small-12 fill-dark text-yellow-2">
						...
						<div class="card-content px-50">
							...
							<div class="bg-img"><img class="block" src="/cms/../content/cms/live-gold-ap-ts.png<?php echo $ver ?>" alt="cash for gold near me" title="cash for gold near me" ></div>
						</div>
					</div>
					<div class="step-break columns small-12">
						<div class="row text-neutral-3 space-75-left-right space-75-top">
					...
					<div class="card rgs7 columns small-12 fill-light">
						...
						<div class="card-content px-50">
							...
							<div class="bg-img"><img class="block" style="padding-left:35px;" src="/cms/../content/cms/gold-purity-ap-ts.png<?php echo $ver ?>" alt="gold sale near me" title="gold sale near me" ></div>
						</div>
					</div>
					<!-- CARD: 8 -->
