				...
				<div class="step-card-grid row">
					...
					<div class="card rgs2 columns small-12 fill-light">
						...
						<div class="card-content px-50">
							...
							<div class="bg-img"><img class="block" src="/content/cms/gold-purity-kl.png<?php echo $ver ?>" alt="where can i sell gold for cash near me" title="where can i sell gold for cash near me"></div>
						</div>
					</div>
					<!-- CARD: 3 -->
					<div class="card rgs3 columns small-12 fill-light">
						...
						<div class="card-content px-50">
							...
							<div class="bg-img"><img class="block" src="/content/cms/carry-id-proof-kl.png<?php echo $ver ?>" alt="best place to sell gold jewelry for cash near me" title="best place to sell gold jewelry for cash near me"></div>
						</div>
					</div>
					<!-- CARD: 1 -->
						...
						<div class="card-content px-50">
							<div class="row">
								<div class="columns small-9 small-offset-1 space-50-left-right space-50-bottom">
									...
									<div class="mt-25 h5 medium" style="text-shadow: 1px 1px 1px rgba(0,0,0,0.15)">Across Karnataka, Andhra Pradesh,<br>Kerala and Telangana</div>
							...
							<div class="mt-250 mb-50 row">
								<div class="columns small-12 medium-offset-1 medium-8 md:pl-50">
									<?= C\VideoChip( 'Find a Branch', '03:45', 'hATgnPHoHZ8', '/cms/../content/cms/find-a-branch-l.jpg' ) ?>
								</div>
							</div>
							<div class="bg-img"><img class="block" src="/content/cms/find-a-branch-kl.png<?php echo $ver ?>" alt="best place to sell gold near me" title="best place to sell gold near me">  </div>
						</div>
					</div>
					...
					<div class="card rgs4 columns small-12 fill-light">
						...
						<div class="card-content px-50">
							...
							<div class="mt-50 mb-50 row">
								<div class="columns small-12 medium-offset-1 medium-8 md:pl-50">
									<?= C\VideoChip( 'KYC Verification', '02:54', 'KHDuMePXBXk', '/cms/../content/cms/kyc-verification-kl.jpg' ) ?>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card-content px-50">
							...
							<div class="mb-50 pt-250 md:pt-100 row">
								<div class="columns small-12 medium-offset-1 medium-8 pt-150 md:pl-50">
									<?= C\VideoChip( 'Live Gold Rate', '06:50', 'mGFw3XYdVuU', '/cms/../content/cms/live-gold-rate-kl.jpg', 'fill-neutral-4', 'rgba( 78, 80, 85, 0.8 )' ) ?>
								</div>
							</div>
							<div class="bg-img"><img class="block" src="/content/cms/check-gold-rate.png<?php echo $ver ?>" alt="cash for gold near me" title="cash for gold near me" ></div>
						</div>
					</div>
					<div class="step-break columns small-12">
						<div class="row text-neutral-3 space-75-left-right space-75-top">
					...
					<div class="card rgs7 columns small-12 fill-light">
						...
						<div class="card-content px-50">
							...
							<div class="mt-250 mb-50 row">
								<div class="columns small-12 medium-offset-1 medium-8 md:pl-50">
									<?= C\VideoChip( 'How is gold purity checked?', '03:25', 'AU_r2ZODEOQ', '/cms/../content/cms/gold-purity-kll.jpg', 'fill-neutral-1', 'rgba( 233, 233, 231, 0.8 )' ) ?>
								</div>
							</div>
							<div class="bg-img"><img class="block" src="/content/cms/purity-check-kl.png<?php echo $ver ?>" alt="gold sale near me" title="gold sale near me" ></div>
						</div>
					</div>
					<!-- CARD: 8 -->
					<div class="card rgs8 columns small-12 fill-light">
						...
						<div class="card-content px-50">
							...
							<div class="mt-50 mb-50 row">
								<div class="columns small-12 medium-offset-1 medium-8 md:pl-50">
									<?= C\VideoChip( 'Instant Payment', '04:38', '9DWWa45uAYE', '/cms/../content/cms/instant-payment-kl.jpg' ) ?>
								</div>
							</div>
						</div>
					</div>
...
.step-cards .sgs2 .card-content .bg-img, .step-cards .rgs2 .card-content .bg-img{
width: 310px !important;
}
.step-cards .sgs3 .card-content .bg-img, .step-cards .rgs3 .card-content .bg-img{
width: 310px !important;
}
}
