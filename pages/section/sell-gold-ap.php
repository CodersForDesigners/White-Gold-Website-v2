<section class="sell-gold-section fill-blue-5 space-200-top space-100-bottom js_section_sell_gold ap-ts-faq-accor" id="sell-gold-section" data-section-title="Sell Gold Section" data-section-slug="sell-gold-section">
	<div class="container">
		<div class="row">
			<div class="intro columns small-12 large-4">
			<div class="h2 strong text-yellow-2">Sell Gold in <?php the_field('add_locationn');?> with<span class="h2 strong text-blue-3"> Seven easy steps</span></div>
			</div>
				...
				<div class="step-card-grid row">
						...
						<div class="card-content px-50">
							<div class="row space-50-top _space-200-top-bottom">
								<div class="columns small-9 small-offset-1 px-50 space-50-bottom">
									...
									<div class="h5 medium mb-200 md:mb-0" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.35)">Across Karnataka, Andhra Pradesh <br>Telangana & Kerala</div>
							...
							<div class="row space-50-bottom">
								<div class="columns small-12 medium-offset-1 medium-8 md:pl-50">
									<?= C\VideoChip( 'Find a Branch', '00:47', 'fe4LANTCszw', '/media/thumbnails/faq-1.jpg' ) ?>
								</div>
							</div>
							<div class="bg-img ap-ts" ><img class="block" src="/cms/../content/cms/branches-ts-ap.png<?php echo $ver ?>" alt="find-branch" title="find-branch"></div>
						</div>
					</div>
					<!-- CARD: 2 -->
					<div class="card sgs3 columns small-12 fill-blue-4">
						...
						<div class="card-content px-50">
							...
							<div class="bg-img"><img class="block" src="/cms/../content/cms/id-proof-ap-ts.png<?php echo $ver ?>" alt="best place to sell gold jewelry for cash near me" title="best place to sell gold jewelry for cash near me"></div>
						</div>
					</div>
					...
					<div class="card sgs4 columns small-12 fill-blue-4">
						...
						<div class="card-content px-50">
							...
							<div class="row space-200-top space-50-bottom">
								<div class="columns small-12 medium-offset-1 medium-8 md:pl-50">
									<?= C\VideoChip( 'How is gold purity checked?', '00:47', 'X0VepRj_lcM', '/media/thumbnails/faq-2.jpg' ) ?>
								</div>
							</div>
							<div class="bg-img"><img class="block" src="/cms/../content/cms/gold-purity-ap-ts.png<?php echo $ver ?>" alt="best place to sell gold near me" title="best place to sell gold near me"></div>
						</div>
					</div>
					<!-- CARD: 4 -->
						...
						<div class="card-content px-50">
								...
								<div class="columns small-10 small-offset-1 medium-6 px-50">
									...
									<div class="fill-neutral-5 radius-50 space-25" style="width: calc(var(--card)/2)">
										<a class="picture-button block fill-yellow-2 text-light" href="/<?= REGION ?>/live-gold">
											<span class="picture-button-bg fill-dark" alt="cash for gold near me" style="background-image: url('/media/background/sell-gold.png<?php echo $ver ?>'); filter: brightness(0.5);" alt=""></span>
											<span class="picture-button-icon">
												<img class="block" src="/media/icon/rupee-white.svg<?php echo $ver ?>" alt="gold buyers near me">
											</span>
							...
							<div class="row mt-250 space-50-bottom">
								<div class="columns small-12 medium-offset-1 medium-8 mt-250 md:mt-0 pt-150 md:pt-0 md:pl-50">
									<?= C\VideoChip( 'Live Gold Rate', '00:56', 'ypBrC4De3oY', '/media/thumbnails/faq-3.jpg', 'fill-neutral-4', 'rgba( 78, 80, 85, 0.8 )' ) ?>
								</div>
							</div>
							<div class="bg-img"><img class="block" src="/cms/../content/cms/live-gold-ap-ts.png<?php echo $ver ?>" alt="gold sale near me" title="gold sale near me"></div>
						</div>
					</div>
					<!-- CARD: 5 -->
					<div class="card sgs6 columns small-12 fill-blue-4">
						...
						<div class="card-content px-50">
							...
							<div class="mt-100 row space-50-bottom">
								<div class="columns small-12 medium-offset-1 medium-8 md:pl-50">
									<?= C\VideoChip( 'KYC Verification', '00:47', 'B8mW8wlAY60', '/media/thumbnails/faq-4.jpg' ) ?>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card sgs7 columns small-12 fill-blue-4">
						...
						<div class="card-content px-50">
							...
							<div class="mt-50 row space-50-bottom">
								<div class="columns small-12 medium-offset-1 medium-8 md:pl-50">
									<?= C\VideoChip( 'Instant Payment', '00:41', 'H0lEceCASI0', '/media/thumbnails/faq-5.jpg' ) ?>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card sgs2 columns small-12 fill-blue-4">
						...
						<div class="card-content px-50">
							...
							<div class="bg-img"><img class="block" src="/cms/../content/cms/invoice-ap-ts.png<?php echo $ver ?>" alt="places to sell gold near me" title="places to sell gold near me"></div>
						</div>
					</div>
				</div>
			</div>
