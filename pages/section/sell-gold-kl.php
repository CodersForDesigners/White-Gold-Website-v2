				...
				<div class="step-card-grid row">
						...
						<div class="card-content px-50">
							<div class="row space-50-top _space-200-top-bottom">
								<div class="columns small-9 small-offset-1 px-50 space-50-bottom">
									...
									<div class="h5 medium mb-200 md:mb-0" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.35)">Across Karnataka, Andhra Pradesh,<br>Telangana and Kerala</div>
							...
							<div class="row space-50-bottom">
								<div class="columns small-12 medium-offset-1 medium-8 md:pl-50">
									<?= C\VideoChip( 'Find a Branch', '00:47', 'hATgnPHoHZ8', '/cms/../content/cms/find-a-branch-l.jpg' ) ?>
								</div>
							</div>
							<div class="bg-img"><img class="block" src="/content/cms/find-a-branch-kl.png<?php echo $ver ?>" alt="find-branch" title="find-branch"></div>
						</div>
					</div>
					<!-- CARD: 2 -->
					...
					<div class="card sgs4 columns small-12 fill-blue-4">
						...
						<div class="card-content px-50">
							...
							<div class="row space-200-top space-50-bottom">
								<div class="columns small-12 medium-offset-1 medium-8 md:pl-50">
									<?= C\VideoChip( 'How is gold purity checked?', '00:47', 'AU_r2ZODEOQ', '/cms/../content/cms/gold-purity-kll.jpg' ) ?>
								</div>
							</div>
							<div class="bg-img"><img class="block" src="/content/cms/purity-check-kl.png<?php echo $ver ?>" alt="best place to sell gold near me" title="best place to sell gold near me"></div>
						</div>
					</div>
					<!-- CARD: 4 -->
						...
						<div class="card-content px-50">
							...
							<div class="row mt-250 space-50-bottom">
								<div class="columns small-12 medium-offset-1 medium-8 mt-250 md:mt-0 pt-150 md:pt-0 md:pl-50">
									<?= C\VideoChip( 'Live Gold Rate', '00:56', 'mGFw3XYdVuU', '/cms/../content/cms/live-gold-rate-kl.jpg', 'fill-neutral-4', 'rgba( 78, 80, 85, 0.8 )' ) ?>
								</div>
							</div>
							<div class="bg-img"><img class="block" src="/content/cms/check-gold-rate.png<?php echo $ver ?>" alt="gold sale near me" title="gold sale near me"></div>
						</div>
					</div>
					<!-- CARD: 5 -->
					<div class="card sgs6 columns small-12 fill-blue-4">
						...
						<div class="card-content px-50">
							...
							<div class="mt-100 row space-50-bottom">
								<div class="columns small-12 medium-offset-1 medium-8 md:pl-50">
									<?= C\VideoChip( 'KYC Verification', '00:47', 'KHDuMePXBXk&t', '/cms/../content/cms/kyc-verification-kl.jpg' ) ?>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card sgs7 columns small-12 fill-blue-4">
						...
						<div class="card-content px-50">
							...
							<div class="mt-50 row space-50-bottom">
								<div class="columns small-12 medium-offset-1 medium-8 md:pl-50">
									<?= C\VideoChip( 'Instant Payment', '00:41', '9DWWa45uAYE', '/cms/../content/cms/instant-payment-kl.jpg' ) ?>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card sgs2 columns small-12 fill-blue-4">
						...
						<div class="card-content px-50">
							...
							<div class="bg-img"><img class="block" src="/content/cms/earn-a-bonus-kl.png<?php echo $ver ?>" alt="places to sell gold near me" title="places to sell gold near me"></div>
						</div>
					</div>
				</div>
			</div>
