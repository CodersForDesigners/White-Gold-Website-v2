...
<div class="main-menu columns small-12 medium-6 medium-offset-3 large-12 large-offset-0 fill-dark radius-50 js_whatsapp_form_section js_main_menu">
	<div class="row">
		...
		<input id="toggle-menu-open-<?= $whatsappId ?>" type="checkbox" aria-label="toogle-menu"  name="toggle-menu-open" class="toggle-menu-open visuallyhidden js_primary_toggle_menu">
		...
		<div class="menu-content columns small-12 large-9">
			<div class="row space-25">
				<div class="columns small-6 large-4 space-25 btn1-<?php echo basename(get_permalink()); ?>">
					<a class="menu-button menu-button-large block fill-blue-4" href="/<?= REGION ?>/branches">
						<span class="menu-button-bg" style="background-image: url('/media/background/find-branch.png<?php echo $ver ?>'); filter: brightness(0.9);" alt="menu-bar"></span>
						<span class="menu-button-icon">
							<img class="block" src="/media/icon/location-white.svg<?php echo $ver ?>" alt="whatsapp-icon">
						</span>
						<span class="menu-button-label">Find Nearest <br class="hide-large hide-xlarge">Branch</span>
					</a>
				</div>
				<div class="columns small-6 large-4 space-25 btn2-<?php echo basename(get_permalink()); ?>">
					<a class="menu-button menu-button-large block fill-yellow-2 text-light" href="/<?= REGION ?>/live-gold">
						<span class="menu-button-bg fill-dark" style="background-image: url('/media/background/sell-gold.png<?php echo $ver ?>'); filter: brightness(0.5);" alt="sell-gold"></span>
						<span class="menu-button-icon">
							<img class="block" alt="rupee" src="/media/icon/rupee-white.svg<?php echo $ver ?>">
						</span>
						<span class="menu-button-label">Live Gold <br class="hide-large hide-xlarge">Rate</span>
					</a>
				</div>
				<div class="columns small-6 large-2 space-25 btn3-<?php echo basename(get_permalink()); ?>">
					<a class="menu-button block fill-blue-5" href="/<?= REGION ?>#sell-gold-section">Sell Gold</a>
				</div>
				<div class="columns small-6 large-2 space-25 btn4-<?php echo basename(get_permalink()); ?>">
		...
		<div class="menu-head columns small-12 large-3">
			<div class="row space-25">
				<div class="toggle-whatsapp columns small-2 large-3 space-25">
					<label class="menu-button block fill-neutral-5" style="--bg-image: url( '/media/icon/vertical-dots.white.svg<?= $ver ?>' ); background-color: #32AF74;" for="toggle-whatsapp-open-<?= $whatsappId ?>" alt="whatsapp">
						<span class="l1"></span>
						<span class="l2"></span>
						<img class="block" src="/media/icon/whatsapp-outline.svg<?= $ver ?>" alt="whatsapp-icon">
					</label>
				</div>
				...
				<div class="toggle-menu columns small-2 small-offset-1 large-3 large-offset-0 space-25 hide-large hide-xlarge">
					<label class="menu-button block fill-neutral-5" style="--bg-image: url( '/media/icon/vertical-dots.white.svg<?= $ver ?>' )" for="toggle-menu-open-<?= $whatsappId ?>" alt="whitegold gold near me">
						<span class="l1"></span>
						<span class="l2"></span>
						<span class="l3"></span>
					</label>
		...
		<div class="whatsapp-form fill-dark columns small-12 large-4">
			<div class="">
				<form class="form-card form-dark row space-25 js_whatsapp_form" onsubmit="event.preventDefault()" data-number="<?= $contactNumbersForRegions[ REGION ] ?>">
					...
					<div class="columns small-2 space-25">
						<button class="send-to-whatsapp block fill-neutral-5" type="submit"><img class="block" src="/media/icon/whatsapp-outline.svg<?= $ver ?>" alt="whitegold"></button>
					</div>
				</form>
			</div>
		</div>
