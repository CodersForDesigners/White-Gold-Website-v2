...
<h2 class="pb-4">Releasing Your Gold Loan Just Got Easier with 8 Simple Steps</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Walk into the nearest White Gold Branch <span class="text-white">No appointments, no pressure. Visit your nearest branch, and we will guide you through the process.</span></h4>
...
<h4 class="text-white">Bring Your Pledge Receipt <span class="text-white">Keep your pledge receipt with you. This helps us verify the details of your loan and start the release process smoothly.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Carry Your ID Proof<span class="text-white">Bring an Aadhaar, PAN, or any valid government ID. This is just to ensure secure and verified transactions.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Let Us Contact Your Lender <span class="text-white">We will communicate with the loan provider and settle the dues directly.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">We Close the Loan for You  <span class="text-white">Once verified, we will pay off the remaining loan amount to release your gold.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Get Real-Time Rate Transparency  <span class="text-white">Before any deal, we show you the exact live gold rate. So you know you are getting a fair price.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Gold Testing, Done Right <span class="text-white">Using advanced XRF machines, we test your gold for purity in front of you. No damage. No doubt.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Payout to Your Bank<span class="text-white">After completing the testing, your full amount is transferred directly to your bank account. Fast and secure.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<div class="container">
    <div class="text-center mt-3 mb-4"><h2>Smart Sellers in Himayatnagar Choose White Gold – Here’s Why</h2></div>
...
<img src="/cms/../content/cms/Group.svg" class="img-fluid mb-2" alt="Technology Driven logo" title="Technology Driven"><p class="mt-1">Tech-Driven Accuracy</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-1.svg" class="img-fluid mb-2" alt="Wide Network Of Branches icon" title="Wide Network Of Branches"><p class="mt-1">Strong South India Network</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-2.svg" class="img-fluid mb-2" alt="Professional Team icon" title="Professional Team"><p class="mt-1">Expert Staff, Transparent Service</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
...
<img src="/cms/../content/cms/Group-4.svg" class="img-fluid mb-2" alt="White Group Conglomerate icon" title="White Group Conglomerate"><p class="mt-1">Backed by the White Group</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-5.svg" class="img-fluid mb-2" alt="Live Gold Rate - White Gold" title="Live Gold Rate"><p class="mt-1">Live Market-Based Gold Rates</p>
</div></div>
<!-- box ends --></div>
</div>
