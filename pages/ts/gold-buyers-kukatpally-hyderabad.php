...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ts/gold-buyers-kukatpally-hyderabad';
...
<h2 class="pb-4">Claim Back Your Gold in 8 Simple Steps With White Gold</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring The Pledge Receipt <span class="text-white">We will need your original pledge receipt to get things started and match the records.</span></h4>
...
<h4 class="text-white">Carry a Valid Photo ID <span class="text-white">Aadhaar, passport, or any government ID works! Just something to confirm your identity.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Drop by Our Branch<span class="text-white">Walk into any nearest White Gold branch in Kukatpally. Our friendly team will guide you through every step.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Quick KYC & Security Check <span class="text-white">We will verify your identity and address, usually with a short phone confirmation. Simple and secure.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Check the Gold Rate Live  <span class="text-white">No guesswork here. We use real time gold rates and precise purity checks to value your gold fairly.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Close Your Loan Smoothly  <span class="text-white">After verifying everything, we will settle your gold loan with total clarity and no hidden steps.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Purity Check, the Right Way <span class="text-white">Your gold is tested using XRF tech. No scratches, no damage, just fast and accurate results.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Get Paid Instantly <span class="text-white">The best part! We transfer the full amount straight to your bank account before you even leave the branch.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<div class="container">
    <div class="text-center mt-3 mb-4"><h2>What Makes White Gold the Most Trusted Gold Buyers in Kukatpally</h2></div>
...
<img src="/cms/../content/cms/Group.svg" class="img-fluid mb-2" alt="Technology Driven logo" title="Technology Driven"><p class="mt-1">Tech-Driven Precision</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-1.svg" class="img-fluid mb-2" alt="Wide Network Of Branches icon" title="Wide Network Of Branches"><p class="mt-1">100+ Branches Across South India </p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-2.svg" class="img-fluid mb-2" alt="Professional Team icon" title="Professional Team"><p class="mt-1">Trained Experts, Transparent Process</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-3.svg" class="img-fluid mb-2" alt="Complaint Redressal System icon" title="Complaint Redressal System"><p class="mt-1">Dedicated Support</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-4.svg" class="img-fluid mb-2" alt="White Group Conglomerate icon" title="White Group Conglomerate"><p class="mt-1">Backed by the White Group Legacy</p>
</div></div>
<!-- box ends --><div class="columns small-6 large-4 mb-1 mt-1">
<div class="grey-box bg-grey">
 
<img src="/cms/../content/cms/Group-5.svg" class="img-fluid mb-2" alt="Live Gold Rate - White Gold" title="Live Gold Rate"><p class="mt-1">Check Live Gold Rates Anytime</p>
</div></div>
<!-- box ends --></div>
</div>
