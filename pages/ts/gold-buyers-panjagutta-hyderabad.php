...
<h2 class="pb-4">Releasing Your Gold Loan? White Gold Make It Smooth with 8 simple steps</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Bring Your Pledge Slip <span class="text-white">Your original loan receipt helps us verify and fast track your gold release.</span></h4>
...
<h4 class="text-white">Carry a Valid ID <span class="text-white">Aadhaar, Passport, or any government ID will do — for smooth and secure KYC.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Reach out to the nearest White Gold branch.<span class="text-white">Visit our nearest branch in Panjagutta. As the trusted gold buyers in Panjagutta, we are ready to guide you through every step.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Quick KYC Verification <span class="text-white">Our team will confirm your identity and address with a quick phone verification just for added safety.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Know Your Gold’s True Worth  <span class="text-white">We use XRF machines to test your gold purity. 100% accurate, non-destructive, and done in front of you.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Check the Live Rate  <span class="text-white">We calculate your gold value based on real time market rates. No outdated pricing, no unfair quotes.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Loan Closed, Gold Unlocked <span class="text-white">Once verified, we will help close your existing loan and release your gold, all with full transparency.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Payment? Instant. <span class="text-white">Get your money instantly via direct bank transfer. Quick, safe, and confirmed before you leave.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
