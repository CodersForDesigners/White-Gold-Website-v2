...
if ( \BFS\Router::$urlSlug == '' )
	return require_once __ROOT__ . '/pages/ts/sell-gold-dilsukh-nagar';
...
<h2 class="pb-4">Release Gold In Dilsukh Nagar in 8 Simple Steps</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Carry Your Pledge Receipt <span class="text-white">Bring your original pledge receipt. It will help us quickly verify and speed up the gold release process.</span></h4>
...
<h4 class="text-white">Bring a Valid Photo ID <span class="text-white">For fast and secure KYC verification, you need to submit your Aadhaar card, Passport, or any government issued ID.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Visit White Gold Dilsukh Nagar<span class="text-white">To sell gold in Dilsukh Nagar, walk into our White Gold branch and our friendly staff will guide you.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Complete KYC and Security Check <span class="text-white">We verify your identity and address quickly with a phone confirmation for added safety.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Check the Live Gold Rate  <span class="text-white">We use live MCX rates, so you always get the most accurate and fair value for your gold.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Close Your Gold Loan  <span class="text-white">After all the verification is done, your loan will be closed fully.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Confirm Your Gold Purity <span class="text-white"> Next, we will check your gold purity. Our XRF machines provide accurate, non-destructive purity testing.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Receive Instant Bank Transfer<span class="text-white">Finally, the agreed amount is sent directly to your bank account, fast and safe.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<div class="container">
    <div class="text-center mt-3 mb-4"><h2>Why White Gold is the Smart Choice to Sell Gold for Cash in Dilsukh Nagar</h2></div>
