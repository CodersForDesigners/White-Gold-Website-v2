...
<h2 class="pb-4">Release Gold in Toli Chowki With These 8 Easy Steps</h2></div>
<div class="container">
  <!-- row start -->
<div class="row">
<!-- col start -->
...
<h4 class="text-white">Carry Your Pledge Receipt <span class="text-white">Carry the original receipt of your pledged gold. It will be helpful for quick and smooth verification.</span></h4>
...
<h4 class="text-white">Bring a Valid Photo ID <span class="text-white">Walk into our branch and share your gold loan details with our expert team.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Loan Verification<span class="text-white">We directly verify your loan with the respective bank or financier to ensure accuracy.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Check Outstanding Balance <span class="text-white">Then, our staff will calculate the exact amount needed to close your loan.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Repayment Support  <span class="text-white">White Gold clears your dues quickly and transparently on your behalf.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Gold Release Process  <span class="text-white">We safely collect your pledged gold from the loan provider and handle everything securely.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Purity and Weight Check <span class="text-white"> Your gold will be tested in front of you with advanced XRF machines for 100% accuracy.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<h4 class="text-white">Instant Bank Settlement<span class="text-white">You can sell gold in Toli Chowki immediately and receive payment through a secure bank transfer, fast and hassle free.</span></h4>
<!-- <p class="text-white">Contact your nearest branch to sell gold.</p> -->
...
<div class="container">
    <div class="text-center mt-3 mb-4"><h2>White Gold – Your Go-To Gold Buyers in Toli Chowki</h2></div>
